  ...
  <body>
    <div class="container_principal_agenda centro_lr bg_branco float_left borda_preta_1 margem_l_20">
      ...
      <div class="container_datas float_left">
        ...
        <div class="item_datas_agenda preenche_t_30 margem_t_20 align_center fs_20 negrito">
          Data
        </div>

        <div class="item_datas_agenda preenche_t_30 margem_t_30 align_center fs_20 negrito">
          Data
        </div>
      ...
      <div class="container_caixas_agenda float_left margem_l_100">
      ...
      <div class="container_propaganda borda_preta_1 float_left margem_l_70 margem_t_20">
