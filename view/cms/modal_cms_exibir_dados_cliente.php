...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container_img_cliente">
      <img src="<?=$dadosCliente->foto_perfil?>" alt="Foto do cliente">
    ...
    <div class="labelExibicaoDados preenche_25 titulo fs_20">
      <a id="arrow_cliente" href="#">
        Cliente
        <i id="icone_arrow_cliente" class="material-icons">keyboard_arrow_down</i>
      </a>
    </div>
