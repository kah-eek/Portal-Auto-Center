...
CREATE TABLE `tbl_anuncio_veiculo_parceiro` (
  ...
  CONSTRAINT `fk_tbl_anuncio_veiculo_parceiro` FOREIGN KEY (`id_veiculo_parceiro`) REFERENCES `tbl_veiculo_parceiro` (`id_veiculo_parceiro`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_nivel_usuario` VALUES (1,'1');
...
INSERT INTO `tbl_usuario` VALUES (1,'a','1',NULL,1,1);
...
-- Dump completed on 2018-03-27  1:34:30
